...
#### 確定済みアセット: 攻撃型バトルシップ (naobanapro作)
サイドビュー（やや俯瞰）のイラストが1枚確定している。特徴:
- **全体シルエット**: 横長・重厚なボディ、幅広の中央胴体から前方に向かって細くなる
- **装甲**: 厚い多面体装甲パネル、ボルト・継ぎ目・パネルラインが細かく描写
- **戦闘ダメージ**: 焦げ跡・擦り傷・汚れが全体に入りリアルな使用感
- **砲塔**: 連装砲塔が上面2基（前後）+ 下面後方1基。細い砲身2本
- **ミサイルポッド**: 側面前方に縦列複数段のミサイルランチャー（赤い弾頭が見える）
- **スラスター**: 左側面（船尾）に大型スラスター2基。シアンブルーの炎が後方に噴射
- **アクセントライト**: 緑色の小さなライトが艦体各所に点在
- **カラー**: くすんだベージュ〜グレーの金属色、黒い宇宙背景にネビュラ/煙雲
- **スタイル**: アニメ調だが重厚でリアル寄り。Homeworld的重戦艦の雰囲気
- **視点**: サイドビュー（ゲーム内はこれをトップダウン用に加工予定）
